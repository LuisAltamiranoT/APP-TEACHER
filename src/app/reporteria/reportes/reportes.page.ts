...
import { ReporteIndividualPage } from 'src/app/reporteria/reporte-individual/reporte-individual.page';
...
export class ReportesPage implements OnInit {
  ...
  cargar() {
    ...
    this.suscripcion1 = this.authService.getDataNominaCursoId(this.idMateria, this.idNomina).subscribe((data) => {
      ...
      if (dataNomina.nomina[0].asistencia.length === 1) {
  ...
  filtrar() {
    ...
    } else if (inicio != '' && fin == '' || inicio != null && fin == null) {
  ...
  onclick(estado: any, index: any, discol: any) {
    ...
    this.openMaterial1(ReporteIndividualPage, data);
  }
